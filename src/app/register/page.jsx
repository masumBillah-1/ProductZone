      ...
      <main className="flex-1 flex items-stretch min-h-screen">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-3 md:p-4 auth-bg-pattern">
          ...
          >
            ...
            >
              <Logo className="w-12 h-12 mx-auto lg:mx-0" textClassName="text-xl" />
            </motion.div>
            ...
            {error && (
              <motion.div 
                className="p-2 bg-rose-50 dark:bg-rose-500/10 border border-rose-200 dark:border-rose-500/20 rounded-lg"
            ...
            <motion.p 
              className="text-center text-[10px] text-slate-600 dark:text-slate-400"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        >
          ...
          />
          <motion.div 
            className="absolute inset-0 z-20 flex flex-col justify-end p-20 text-white"
