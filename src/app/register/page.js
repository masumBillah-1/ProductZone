      ...
      <main className="flex-1 flex items-stretch min-h-screen">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-3 md:p-4 auth-bg-pattern">
          <div className="w-full max-w-[360px] space-y-3">
            ...
            <button className="w-full flex items-center justify-center gap-2 px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors font-semibold text-[11px]">
            ...
            <form className="space-y-2.5">
              ...
              <button
                className="w-full bg-primary text-white py-2 rounded-lg font-bold text-xs hover:shadow-lg hover:shadow-primary/20 active:scale-[0.98] transition-all"
                type="submit"
              >
                Create Account
              </button>
